        ...
        <div className="flex flex-col gap-4 md:gap-8 justify-center md:mt-0 mt-40 md:w-1/2">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-poppins font-semibold text-2xl text-black dark:text-white">
                About
              </h1>
            </div>
            ...
            <p className="font-inter font-medium text-gray-600 dark:text-white">
              ...
              <span className="font-semibold text-black dark:text-[#00BCFF]">
                React, Next.js, and TypeScript
              </span>
              . I enjoy building fast, scalable, and intuitive web applications
