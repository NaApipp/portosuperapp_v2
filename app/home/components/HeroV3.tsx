...
import FadeRight from "@/app/components/animations/FadeRight";
import FadeLeft from "@/app/components/animations/FadeLeft";
...
export default function HeroV3() {
  ...
  return (
    <>
      <section
        id="home"
        className="w-full max-w-7xl mx-auto cursor-default grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center px-6 md:px-12 py-24 md:py-32 overflow-hidden"
      >
        <FadeLeft>
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              >{`${texts[index].substring(0, subIndex)}`}</span>
              <span className="animate-cursor text-text-secondary text-2xl lg:text-3xl font-light">
                |
              </span>
            </div>
            ...
            <div className="max-w-xl mt-4">
              <p className="text-text-secondary text-base md:text-lg leading-relaxed font-medium">
                A Full-stack Web Developer proficient in React, Next.js, and
                TypeScript, focused on developing innovative solutions using the
                latest technologies, as well as a QA Engineer experienced in
            ...
            <div className="mt-12 pt-8 border-t border-text-secondary/10">
              <span className="text-xs uppercase tracking-widest font-bold text-text-secondary mb-4 block">
                Connect
              </span>
          ...
          <div className="flex flex-col items-center justify-center relative mt-12 md:mt-0">
            ...
            <div className="absolute -bottom-10 md:-bottom-12 -left-4 md:-left-12 z-20 flex flex-col gap-3">
              {quickStatsList.map((stat, index) => (
                <div
                  className={`floating flex items-center gap-3 bg-background/90 backdrop-blur-md border border-text-secondary/10 p-3 pr-5 rounded-2xl shadow-xl hover:-translate-y-1 transition-transform duration-300 animate-in fade-in slide-in-from-bottom-5`}
...
const socialMediaList = [
  {
    href: "https://instagram.com/n_apipppp",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-5 w-5"
...
const quickStatsList = [
  ...
  {
    message: "TypeScript Main Language",
    icon: (
      <svg
        className="w-5 md:w-6 text-text-background"
        aria-hidden="true"
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="2"
          d="M5 12V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v5M5 12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2M5 12h14m-7 4v3m-4 0h8"
        />
      </svg>
    ),
  },
